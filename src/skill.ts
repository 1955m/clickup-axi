...
export const SKILL_DESCRIPTION =
  "Operate ClickUp through the clickup-axi CLI - teams/workspaces, spaces, folders, lists, " +
  "tasks (list/view/create/update/delete/comments/custom-fields/dependencies), comments, views, " +
  "docs, time tracking, tags, attachments, and raw API access. " +
  "Use whenever a task touches ClickUp: listing or creating tasks, navigating the " +
  "team/space/folder/list hierarchy, reading or setting custom fields by NAME, inspecting or " +
  "logging time, managing tags or attachments, browsing views and docs, or calling the " +
  "ClickUp API v2 directly.";
